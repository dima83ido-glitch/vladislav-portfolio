    ...
    <section id="contact" className="relative overflow-hidden py-32 lg:py-40">
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-12">
        <SectionHeading
          ...
          description="Tell me about your project — timeline, goals, and what 'done' looks like. I reply within one business day."
        />
        ...
        <div className="mx-auto mt-24 grid max-w-3xl grid-cols-1 gap-5 sm:grid-cols-3">
          {CONTACT_METHODS.map((method, i) => (
            <Reveal key={method.label} variant="up" delay={0.1 + i * 0.1}>
              <motion.a
                href={method.href}
                target={method.label !== "Email" ? "_blank" : undefined}
                rel={method.label !== "Email" ? "noreferrer noopener" : undefined}
                whileHover={{ y: -6 }}
